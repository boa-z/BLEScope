...
REPO_URL = "boa-z/BLEScope"
SOURCE_JSON = Path(".github/apps.json")
NIGHTLY_TAG = "nightly"
NIGHTLY_IPA_NAME = "BLEScope.ipa"
APP_ICON_URL = "https://github.com/boa-z.png"
...
def default_source() -> dict:
    return {
        "name": "BLEScope",
        "identifier": "com.example.blescope",
        "website": f"https://github.com/{REPO_URL}",
        "subtitle": "BLEScope official AltStore source.",
        "description": (
            "This is the official AltStore source for BLEScope.\n\n"
            "Scan nearby BLE peripherals, inspect services and characteristics, read and write payloads, "
            "monitor notifications, and export debugging logs."
        ),
        "tintColor": "#0F766E",
        ...
        "apps": [
            {
                "beta": False,
                "name": "BLEScope",
                "bundleIdentifier": "com.example.blescope",
                "developerName": "boa",
                "subtitle": "SwiftUI BLE debugging tool for iPhone and iPad.",
                ...
                "appPermissions": {
                    ...
                    "privacy": {
                        "NSBluetoothAlwaysUsageDescription": (
                            "Bluetooth access is required for BLE scanning, connecting, and debugging."
                        ),
